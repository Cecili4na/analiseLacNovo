    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div>
                    ...
                    <p className="text-black/80">O analista cria um teste sensorial definindo os atributos a serem avaliados.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-6">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#8BA989] text-white text-lg font-medium rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-semibold text-xl mb-2 text-black">Avaliação</h3>
                    <p className="text-black/80">Os avaliadores realizam a análise sensorial dos produtos.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-6">
                  <div className="flex-shrink-0 w-12 h-12 bg-[#8BA989] text-white text-lg font-medium rounded-lg flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-semibold text-xl mb-2 text-black">Resultados</h3>
                    <p className="text-black/80">Geração de relatórios e análises estatísticas dos dados coletados.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 bg-[#F0F0E5]">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-black text-center mb-12">Benefícios da Plataforma</h2>
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="p-6">
                ...
                <p className="text-black/80">Coleta padronizada de dados com validação automática.</p>
              </div>
              <div className="p-6">
                <div className="w-12 h-12 bg-[#8BA989] text-white rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-black/80">Processamento eficiente e geração rápida de resultados.</p>
              </div>
              <div className="p-6">
                <div className="w-12 h-12 bg-[#8BA989] text-white rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-xl font-semibold mb-2 text-black">Relatórios Detalhados</h3>
                <p className="text-black/80">Visualização clara e detalhada dos resultados obtidos.</p>
              </div>
            </div>
          </div>
        </section>
